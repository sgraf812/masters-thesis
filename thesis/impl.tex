...
Changes are scattered over a huge number of files, so the implementation is only available at \url{https://github.com/sgraf812/ghc} under the branch \texttt{cocall-full}\footnote{And of course in the medium attached to the submission.}.
...
The file \texttt{Visfun\_Lazy.hs} will violate a monotonicity check.
