...
\begin{table}
  ...
  \end{tabular}
  \caption{
    Performance figures recorded while compiling GHC and nofib with the three variants, relative to GHC 8.2.1.
...
Every variant consumes more resources than the baseline. 
