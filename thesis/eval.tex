...
Alloction results are summarised in \cref{tbl:alloc}.
...
There is \progname{fannkuch-redux} from the benchmarks game, which regresses significantly by executing 11.4\% more instructions.
...
Memory usage while compiling the \hsinl{LlvmCodeGen} module exceeded the 32 GB of our build machine, probably because of the involvement of \hsinl{DynFlags}, a big tuple.
