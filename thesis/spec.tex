...
The monotonicity assumption also makes for interesting hacks to the implementation in absence of a proper data structure for monotone maps (\cf \cref{todo}).
