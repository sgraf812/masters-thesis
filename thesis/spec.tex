...
In fact, termination bugs regarding monotonicity actually occured while realising the implementation due to the chosen data structures (\cf \tod{impl}).
...
\section{Relationship to Call Arity and Demand Analysis}
...
\subsection{Call Arity and $\eta$-Expansion}\label{sec:generalise}
...
Call arity -- or, expanded arity based on usage -- can be recovered from identifier usage and the results of an arity analysis via the following function:
\[
  \begin{array}{lcl}
...
\todo{Refer to implementation and/or evaluation chapter}
...
We will revisit the issues of how approximate we want usage transformers to be in \tod{finite approximation of usage transformers}.
