...
Equipped with the right language, we would give assign the following usage signatures to \hsinl{f} and \hsinl{g}:
...
\todo{Move this to a prior chapter introducing Call Arity}
...
\Cref{fig:graph} introduces the formal definition for $\sGraph$ and nice syntax for talking about edges within them.
...
\todo{Mention that this only happens for thunks, or refer to where this is written}
