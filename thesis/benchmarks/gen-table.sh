...
nofib-analyse --columns=Allocs,Instrs -l -i 0.1  $pruned | ./fixup.pl $logs > usage-anal-nofib-table.tex
nofib-analyse --columns=Allocs -l -i 0.1  $pruned | ./fixup.pl $logs > usage-anal-nofib-table-alloc.tex
nofib-analyse --columns=Instrs -l -i 0.1  $pruned | ./fixup.pl $logs > usage-anal-nofib-table-instrs.tex
